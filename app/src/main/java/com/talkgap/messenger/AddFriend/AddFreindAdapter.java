...
public class AddFreindAdapter extends RecyclerView.Adapter<AddFriendHolder> {
    Context context;
    ArrayList<AddFriendModel> addFriendModels = new ArrayList<>();

    public AddFreindAdapter(Context context, ArrayList<AddFriendModel> addFriendModels) {
